...
setup(
    ...
    data_files=[('zoe',['zoedepth/models/zoedepth/config_zoedepth.json', 'zoedepth/models/zoedepth/config_zoedepth_kitti.json', 'zoedepth/models/zoedepth_nk/config_zoedepth_nk.json'])]
)
